# PowerShell deployment script for CODESYS ARM64 on k3s
# This script loads Docker images and deploys CODESYS to k3s

param(
    [Parameter(Mandatory=$false)]
    [string]$DockerImageFile = "codesys-arm64.tar",
    
    [Parameter(Mandatory=$false)]
    [string]$Registry = "localhost:5000",
    
    [Parameter(Mandatory=$false)]
    [string]$ImageName = "codesys-arm64",
...
Write-Host "CODESYS ARM64 Deployment to k3s" -ForegroundColor Cyan
Write-Host "================================================" -ForegroundColor Cyan
...
if (-not (Test-Path $DockerImageFile)) {
    ...
    Write-Host "Please provide the path to your CODESYS ARM64 Docker image" -ForegroundColor Yellow
...
Write-Host "CODESYS ARM64 deployment completed successfully!" -ForegroundColor Green
Write-Host "================================================" -ForegroundColor Green
Write-Host ""
Write-Host "To check logs:"
Write-Host "  kubectl logs -n codesys -l app=codesys,arch=arm64 -f"
Write-Host ""
Write-Host "To access the service:"
Write-Host "  kubectl port-forward -n codesys svc/codesys-arm64 1217:1217 8080:8080"
